  ...
  <body >
    ...
    <div class="row  mx-auto mt-lg-5 mb-lg-5  main1">
        ...
        <div class="col-lg-6 col-md-12 bg-light text-dark main">
            ...
            <form class="px-auto " action="EmpRegis" method="post" enctype="multipart/form-data">
            <input type="text" value="EFB" hidden name="ucode">
                ...
                <div class="row mb-3"  >
                  ...
                  <textarea  id="add" cols="55" rows="6" name="addr" id="add" onkeyup="Addvalid()" ></textarea>
                  
                  <div class="invalid-feedback">
        					Address must be include your pin code and lenth of the address should not be exceed more than 200 characters. 	 
      					</div>
      					<div class="valid-feedback">
        					Looks Good!	 
      					</div>
...
function Addvalid()
{
	...
	if(add.test(name)){
		document.getElementById("add").classList.add("is-valid");
		document.getElementById("add").classList.remove("is-invalid");
		
	}else{
		document.getElementById("add").classList.add("is-invalid");
        document.getElementById("add").classList.remove("is-valid");
	}
}
</script>
  </body> 
